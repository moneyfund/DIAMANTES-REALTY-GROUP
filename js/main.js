...
function getViewportBounds(element, padding = 24) {
  ...
  const safeFooterTop = footerTop > 0 ? footerTop : window.innerHeight;
  const maxY = Math.max(Math.min(window.innerHeight, safeFooterTop) - element.offsetHeight - padding, padding);
